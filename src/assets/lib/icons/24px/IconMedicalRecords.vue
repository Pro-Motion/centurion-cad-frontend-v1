<template>
  <g>
    <path d="m13.7,9.94h-6.75c-.55,0-1-.45-1-1s.45-1,1-1h6.75c.55,0,1,.45,1,1s-.45,1-1,1Z" />
    <path d="m13.7,6.94h-6.75c-.55,0-1-.45-1-1s.45-1,1-1h6.75c.55,0,1,.45,1,1s-.45,1-1,1Z" />
    <path d="m10.84,15.85h-3.75c-.55,0-1-.45-1-1s.45-1,1-1h3.75c.55,0,1,.45,1,1s-.45,1-1,1Z" />
    <path d="m13.84,12.85h-6.75c-.55,0-1-.45-1-1s.45-1,1-1h6.75c.55,0,1,.45,1,1s-.45,1-1,1Z" />
    <path
